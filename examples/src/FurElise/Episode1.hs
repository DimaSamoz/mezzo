...
ep1Rh2 = start $ melody :| c' :<<. f' :<<< e' :< e' :| d'
                       :<<. bf' :<<< a' :<< a' :| g'

ep1Rh3 = start $ melody :<< f' :| e' :| d' :| c'

ep1Rh4 = start $ melody :< bf :| a :<<< a :| g :| a :| bf :^ c'
                       :<< d' :| ds' :<. e' :<< e' :| f' :| a :^ c'
                       :<<. d' :<<< b
...
ep1Lh2 = start $ melody :<< f_ :| a_ :| c :| a_ :| c :| a_
                       :| f_ :| bf_ :| d :| bf_ :| d :| bf_ :| f_ :| e

ep1Lh3 = bf_ sn :-: g_ sn :-: f_ sn :|: pad2 (e sn)
     :|: bf_ sn :-: g_ sn :-: f_ sn :|: pad2 (e sn)

ep1Lh4 = pad (start $ melody :<< f_ :| a_ :| c :| a_ :| c :| a_
                            :<< f_ :| a_ :| c :| a_ :| c :| a_
                            :<< e_ :| a_ :| c :| a_)
     :|: d_ oct sc
     :|: pad (start $ melody :<< f_ :| g_ :| e :| g_ :| e :| g_ :| f)
