...
-- bb =
--     ((Note (PC @G) (Acc @Natural) (Oct @Oct3) (Dur @32)) :-:
--     (Note (PC @B) (Acc @Natural) (Oct @Oct3) (Dur @32)) :-:
--     (Note (PC @D) (Acc @Natural) (Oct @Oct4) (Dur @32)) :-:
--     (Note (PC @F) (Acc @Natural) (Oct @Oct4) (Dur @32)))
--     :|:
--     ((Note (PC @G) (Acc @Natural) (Oct @Oct3) (Dur @32)) :-:
--     (Note (PC @C) (Acc @Natural) (Oct @Oct4) (Dur @32)) :-:
--     (Note (PC @E) (Acc @Natural) (Oct @Oct4) (Dur @32)) :-:
--     ((Rest (Dur @16)) :|: ((Rest (Dur @16)))))
--
-- tch =
--     (((Note (PC @E) (Acc @Natural) (Oct @Oct3) (Dur @1)) :-:
--     (Note (PC @G) (Acc @Natural) (Oct @Oct3) (Dur @1)) :-:
